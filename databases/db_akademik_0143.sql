...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 23 Jan 2022 pada 18.20
...
--
-- Struktur dari tabel `tbl_students_0143`
--

CREATE TABLE `tbl_students_0143` (
  `id` int(2) DEFAULT NULL,
  `nim` varchar(10) DEFAULT NULL,
  `nama` varchar(22) DEFAULT NULL,
  `jk` varchar(1) DEFAULT NULL,
  `jurusan` varchar(19) DEFAULT NULL,
  `alamat` varchar(12) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data untuk tabel `tbl_students_0143`
--

INSERT INTO `tbl_students_0143` (`id`, `nim`, `nama`, `jk`, `jurusan`, `alamat`) VALUES
